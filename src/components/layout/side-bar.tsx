			...
			<div className="space-y-4 py-4">
				<div className="px-3 py-2">
					<div className="space-y-1">
						<Link href="/" className="flex flex-row ml-4 mb-3 items-center">
							<span className="text-xl text-[#d955dd] font-bold">Nify</span>
						</Link>
						{navItems.map((item) => (
							<Link key={item.href} href={item.href}>
								...
								>
									...
									{item.label}
									{item.comingSoon && (
										<span className="ml-auto text-xs bg-pink-500 text-white px-2 py-1 rounded-full">
											Soon
										</span>
									)}
								</Button>
